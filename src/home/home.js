...
import { Text, Platform,View, Image, StyleSheet, TouchableOpacity, ScrollView, RefreshControl, ToastAndroid, SafeAreaView } from 'react-native';
...
const Home = ({ navigation }) => {
  ...
  const onRefresh = () => {
    setRefreshing(true);
    setTimeout(() => {
      setRefreshing(false); ToastAndroid.showWithGravityAndOffset(
        'Sayfa Yenilendi.',
        1000,
        1000,
        1000,
